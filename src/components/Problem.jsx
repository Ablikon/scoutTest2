      ...
      <div className="container">
        ...
        <div className="problems-grid">
          ...
          <div className="problem-card">
            ...
            <p>Обновление сотни позиций вручную занимает минимум 2 часа. За это время автоматизированные конкуренты успевают несколько раз пересмотреть стратегию и перехватить трафик.</p>
          </div>
